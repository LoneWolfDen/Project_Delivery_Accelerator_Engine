...
def main() -> None:
    ...
    review_parser.add_argument(
        ...
        choices=["files_only", "ollama", "bedrock", "gemini", "groq", "openrouter"],
...
def cmd_backends(args) -> None:
    ...
    for b in list_backends():
        ...
        print(f"  {b['name']:<14} {b['display_name']:<35} {status}")

    print()
    _info("Configure Groq (free):     export GROQ_API_KEY='your-key' (get at console.groq.com)")
    _info("Configure OpenRouter (free): export OPENROUTER_API_KEY='your-key' (get at openrouter.ai)")
